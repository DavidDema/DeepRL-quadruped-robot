...
def train():
    ...
    storage = Storage(obs_dim=go_env.obs_dim, action_dim=go_env.action_dim, max_timesteps=2000) ##(YAN)## increase (default: 1000)
    ...
    rl_agent.learn(save_dir, num_learning_iterations=250, num_steps_per_val=5, num_plots=5) # start to learn!!

...
class GOEnv(MujocoEnv):
    ...
    def _reward_z_pos(self, after_pos, scaling_factor=1.0):
        # penalize movement in z direction
        dz = after_pos[2] - self.init_joints[2]*0.3
    ...
    def step(self, delta_q):
        ...
        living_reward = self._reward_living(timestep=self.timestep, max_timesteps=self.max_timesteps,
                                            scaling_factor=0.0, positive=False)  # 3.5; fkt 5
        # living_reward = 0
        ...
        foot_slip_reward = self._reward_foot_slip(feet_vel, feet_cont, scaling_factor=0.0)  # fkt 5.0
